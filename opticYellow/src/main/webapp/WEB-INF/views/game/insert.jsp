	...
	<div class="container">
		<main>
			<div class="py-5 text-center">
				...
				<p class="lead">매치 관련 내용을 입력해주세요</p>
			</div>
			...
			<div class="row justify-content-center">
				<div class="col-md-9 col-lg-10 centered-form">
					...
					<form action="g_insertOK.do" method="post"
						enctype="multipart/form-data" class="needs-validation" novalidate
						onsubmit="return validateForm()">

						<div class="row g-3">
							<div class="col-md-12">
								<label for="g_name" class="form-label">제목</label> <input
									type="text" id="g_name" class="form-control" name="g_name"
							...
							<div class="col-md-12">
								...
								<div class="input-group has-validation">
									<input type="text" class="form-control" id="fac_name"
										name="fac_name" placeholder="테니스장 이름을 입력하세요"
										onkeyup="filterFunction()" onclick="openPopup()">
									<div id="popup" class="popup">
										<%
										try {
											Class.forName("oracle.jdbc.OracleDriver");
											Connection con = DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe", "OPTICYELLOW", "hi123456");
										...
										%>
										<a href="#" onclick="selectFacility('<%=facName%>','','')">
											<%=facName%> <br /> <span class="address">시설이 없습니다.</span>
										</a>
										<%
										}
										} catch (Exception e) {
							...
							<div class="col-5">
								...
								<div class="input-group has-validation">
									<select class="form-select" id="g_ntrp" name="g_ntrp" required>
										<option value="1.0">NTRP 1.0</option>
										<option value="1.5">NTRP 1.5</option>
										<option value="2.0">NTRP 2.0</option>
										...
										<option value="5.0">NTRP 5.0</option>
										<option value="5.5">NTRP 5.5</option>
										<option value="6.0">NTRP 6.0</option>
							...
							<div class="col-7">
								...
								<div class="input-group has-validation">
									<select class="form-select" id="g_method" name="g_method"
										...
										<option value="남자단식">남자단식</option>
										<option value="여자복식">여자복식</option>
										<option value="여자단식">여자단식</option>
							...
							<div class="col-6">
								...
								<div class="input-group has-validation">
									<input type='text' class="form-control datetimepicker"
										name='g_start_dt' id='g_start_dt' style='width: 140px;'
										required>
							...
							<div class="col-md-7">
								<label for="g_bill" class="form-label">회비</label> <input
									type="number" value="0" id="g_bill" class="form-control"
									name="g_bill" required>
							...
							<div class="col-12">
								...
								<textarea class="form-control" name="g_info" id="g_info"
									rows="6" placeholder="재밌는 경기, 매너있는 경기, 소중한 인연으로 만나뵙길 기대합니다. "></textarea>
